...
ReceiptModel _$ReceiptModelFromJson(Map<String, dynamic> json) {
  return ReceiptModel(
    ...
    lines: (json['receipt-line'] as List?)
            ?.map((e) => e == null
                ? null
                : ReceiptLineEntity.fromJson(e as Map<String, dynamic>))
            .whereType<ReceiptLineEntity>() // Menghapus nilai null dari list
            .toList() ??
        [],
...
Map<String, dynamic> _$ReceiptModelToJson(ReceiptModel instance) {
  ...
  val['receipt-line'] = instance.lines?.map((e) => e?.toJson())?.toList();
