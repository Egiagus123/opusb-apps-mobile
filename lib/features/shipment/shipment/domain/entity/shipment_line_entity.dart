...
part 'shipment_line_entity.g.dart';

@JsonSerializable(nullable: true, includeIfNull: false)
class ShipmentLineEntity extends BaseEntity {
  @JsonKey(ignore: true)
  ...
  Map<String, dynamic> toJson() => _$ShipmentLineEntityToJson(this);
