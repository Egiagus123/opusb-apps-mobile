...
part of 'assetrequestwindow_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AssetRequestModel _$AssetRequestModelFromJson(Map<String, dynamic> json) {
  return AssetRequestModel(
    ...
    headerID: json['BHP_ToolRequest_ID'] == null
        ? Reference.defaultReference()
        : Reference.fromJson(
...
Map<String, dynamic> _$AssetRequestModelToJson(AssetRequestModel instance) =>
    <String, dynamic>{
      ...
      'BHP_ToolRequest_ID': instance.headerID,
